...
|
*/
Route::middleware('GirisMiddleware')->group(function() {
    Route::get('/', 'App\Http\Controllers\GirisController@giris')->name('giris');
    Route::post('/', 'App\Http\Controllers\GirisController@girisPost')->name('giris.post');
});
...
Route::middleware('AdminMiddleware')->group(function(){
    ...
    Route::get('/notebook', 'App\Http\Controllers\Anasayfa@notebook_fonksiyon')->name('notebook');
...
Route::get('/cikis', 'App\Http\Controllers\GirisController@cikis')->name('cikis');
